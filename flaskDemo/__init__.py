...
params = urllib.parse.quote_plus("Driver={ODBC Driver 17 for SQL Server};Server=tcp:goodnewspartnerswork.database.windows.net,1433;Database=workmanagementSQL;Uid;Encrypt=yes;TrustServerCertificate=yes;Connection Timeout=30;")
